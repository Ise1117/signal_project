...
public class AlertGeneratorTest {
    ...
    private static class TestPatient extends Patient {
        ...
        @Override
        public List<PatientRecord> getRecordsLast(int numRecords, String recordType) {
    ...
    @Test
    void testDecreasingSystolicTrendTriggersAlert() {
    ...
    @Test
    void testIncreasingDiastolicTrendTriggersAlert() {
        addRecord(70, "Diastolic", -3000);
    ...
    @Test
    void testHypotensiveHypoxemiaAlertTriggers() {
        addRecord(85, "Systolic", -1000);
