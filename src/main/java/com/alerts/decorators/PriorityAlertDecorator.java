...
/**
 * This is a decorator class that puts weighs of priority onto alerts.
 *
 * Itextends the functionality of the {@link Alert} class by adding
 * a priority weigh. It uses the Decorator design pattern to wrap an
